...
# code = os.system("go build -o ./release/xsbadmin_mac main.go")
code = os.system("GOOS=linux GOARCH=amd64 go build -o ./release/nginx_log_analy main.go")
if code > 0:
...
ignoredDirs = ["controllers", "controllers_test", "libs", "models", "release", "releasewin", "tests", "api", "router",
               "core_manager", "files", "tools"]
ignoredFiles = ["build_release.py", "build_windows.py", "main.go", "main_t.go", "conf/config.json"]
